...
public:
    ...
    const static unsigned int DEFAULT_GEOMETRY_TYPE_VOLUMETRIC = 0;
    const static unsigned int DEFAULT_GEOMETRY_TYPE_PLANES     = 1;

    explicit MPRDisplay
        ( unsigned int geometryTypeVolumetric = DEFAULT_GEOMETRY_TYPE_VOLUMETRIC
    ...
    const unsigned int geometryTypeVolumetric;
